...
mean_knn = np.mean(y_predict_knn)
std_knn = np.std(y_predict_knn)

print(f"Mean of AdaBoost predictions: {mean_knn}")
print(f"Standard Deviation of AdaBoost predictions: {std_knn}")
...
mean_dtc = np.mean(y_predict_dtc)
std_dtc = np.std(y_predict_dtc)

print(f"Mean of AdaBoost predictions: {mean_ada}")
print(f"Standard Deviation of AdaBoost predictions: {std_ada}")
...
mean_rf= np.mean(y_predict_rf)
std_rf = np.std(y_predict_rf)

print(f"Mean of AdaBoost predictions: {mean_rf}")
print(f"Standard Deviation of AdaBoost predictions: {std_rf}")
...
mean_ada = np.mean(y_predict_ada)
std_ada = np.std(y_predict_ada)
...
mean_xgb = np.mean(y_predict_xgb)
std_xgb = np.std(y_predict_xgb)

print(f"Mean of AdaBoost predictions: {mean_xgb}")
print(f"Standard Deviation of AdaBoost predictions: {std_xgb}")
